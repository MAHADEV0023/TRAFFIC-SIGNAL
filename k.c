...
glClearColor(0.0,0.0,0.0,0.0);/*background for cover page*/
glClear(GL_COLOR_BUFFER_BIT);
glColor3f(1,0,0);
drawstring(450.0,700.0,0.0,"Channabasaveshwara Institute of Technology ");
glColor3f(0.7,0,1);
...
glColor3f(0,1,1);
drawstring(100,350,0.0,"name1 : MAHADEV");
glColor3f(0,1,1);
drawstring(100,300,0.0,"name2 : BHARATH KALYAN S");
glColor3f(0.5,1,1);
drawstring(100,200,0.0,"usn1 : 1cg18CS048");
glColor3f(0.5,1,1);
drawstring(100,140,0.0,"usn2 : 1cg1CS017");
glColor3f(1,1,1);
...
glClear(GL_COLOR_BUFFER_BIT);
glColor3f(0,1,1);
drawstring(550.0,700.0,0.0,"TIPS TO FOLLOW");
...
glColor3f(0,1,1); //color for outer window
glBegin(GL_POLYGON);
glVertex2f(5.0,5.0);
glVertex2f(14.0,5.0);
glVertex2f(11.5,6.5);
